...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    username = models.CharField(
        verbose_name='Username', max_length=20, unique=True, blank=True)
    ...
    reg_num = models.CharField(verbose_name='Registration Number',
                               max_length=10, validators=[reg_num_regex], blank=True)
    phn_num = models.CharField(verbose_name='Phone Number', max_length=10, validators=[
                               phn_num_regex], blank=True)
    gender = models.CharField(verbose_name='Gender',
                              max_length=7, choices=gender_choice, blank=True)
    stream = models.CharField(verbose_name='Stream',
                              max_length=5, choices=stream_choice, blank=True)
    course = models.CharField(verbose_name='Course',
                              max_length=25, choices=course_choice, blank=True)
    is_cr = models.BooleanField(
        verbose_name='Class Representative', default=False, blank=True)
    is_faculty = models.BooleanField(
        verbose_name='Faculty', default=False, blank=True)
    is_active = models.BooleanField(
        verbose_name='Active', default=True, blank=True)
    is_staff = models.BooleanField(
        verbose_name='Staff', default=False, blank=True)
